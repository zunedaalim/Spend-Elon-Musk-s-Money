...
const data=[
    ...
    {
        image:'./Pictures/flip-flops.jpg',
        text:"Flip-Flops",
        price:"₹ 100"
    },  
    {
        image:'./Pictures/Jordan-Expert-Deep-Clean-Toothbrush-315.jpg',
        text:"ToothBrush",
        price:"₹ 315"
    }, 
     {
    ...
    {
        image:'./Pictures/hercules-rf-15610.png',
        text:"Hercules Bicycle",
        price:"₹ 15,610"
    },
    {
        image:'./Pictures/airpods-3rd-gen.jpg',
    ...
    {
        image:'./Pictures/smarttv.jpg',
        text:"Smart TV (55 inch)",
        price:"₹29,999"
    },
    {
        image:'./Pictures/air-jordans.jpg',
        text:"Air Jordan",
        price:"₹ 16,995"
    }
    ,
    ...
    {
        image:'./Pictures/Yellow-Tail-2295.jpg',
        text:"Yellow Tail Wine",
        price:"₹2,295"
        
    },
    {
        image:'./Pictures/ps5.jpg',
        text:"PS-5",
        price:"₹40,000"
    }
    ,
    ...
    ,
    {
        image:'./Pictures/Air-India-77,199.jpg',
    ...
    {
        image:'./Pictures/rolex-air-king-608000.png',
        text:"Rolex Air King",
        price:"₹6,50,000"
    ...
    ,
    {
        image:'./Pictures/Thar-15-lakh.jpg',
        text:"Thar",
        price:"₹15,00,000"
    ...
    ,
    {
        image:'./Pictures/2019-mac-pro-side-and-front.jpg',
        text:"Apple Mac Pro",
        price:"₹7,29,900"
    }
    ,
    {
        image:'./Pictures/Audi-A8.jpg',
        text:"Audi A8",
        price:"₹1,30,00,000"
    ...
    ,
    {
        image:'./Pictures/kawasaki-ninja-h2r-1-69-lakh.jpg',
        text:"Ninja H2R",
        price:"₹79,99,999"
    ...
    ,
    {
        image:'./Pictures/diamond-ring-251036.jpg',
        text:"Diamond Ring",
        price:"₹25,00,000"
    ...
    ,
    {
        image:'./Pictures/avantador-5cr.png',
    ...
    ,
    {
        image:'./Pictures/Buggati-Centodieci-9million.jpg',
    ...
    {
        image:'./Pictures/rambagh-palace-average-30000.jpg',
    ...
    ,
    {
        image:'./Pictures/H145 Airbus helicopter-85cr.jpg',
    ...
    ,
    {
        image:'./Pictures/Mansion-52million.jpg',
        text:"Mansion",
        price:"₹ 426,09,71,000"
    ...
    ,
    {
        image:'./Pictures/3-BHK-Luxury-flat-in-south-bombay-3.89cr.jpg',
    ...
    ,
    {
        image:'./Pictures/Jet-Gulfstream-G450-8,000,000.jpg',
        text:" Jet Gulfstream",
        price:"₹ 65,55,52,800"
    ...
    {
        image:'./Pictures/samsung-micro-led-display-the-wall-12crore.jpg',
    ...
    ,
    {
        image:'./Pictures/cyberdog-1,18,213.jpg',
        text:"Cyberdog",
        price:"₹ 20,00,000"
    ...
    ,
    {
        image:'./Pictures/formula1-700mil.jpg',
    ...
    ,
    {
        image:'./Pictures/emirates-first-class-5,02,876.jpg',
    ...
    ,
    {
        image:'./Pictures/Jacob_Co_-_The_Billionaire_Watch_-18_million1.png',
    ...
    ,
    {
        image:'./Pictures/produce-90mil.jpg',
    ...
    ,
    {
        image:'./Pictures/graff hallucination watch-55-million.jpg',
    ...
    ,
    {
        image:'./Pictures/toilet-30000.jpg',
        text:" Golden Toilet",
        price:"₹ 24,57,000"
    ...
    {
        image:'./Pictures/jeff-house-165million.jpg',
   ...
   ,
    ...
    ,
    {
        image:'./Pictures/indian_army_jetpack_getty_2-sixteen_nine-400,000dollar.jpg',
        text:"Jetpack",
        price:"₹ 3,30,00,000"
    ...
    ,
    {
        image:'./Pictures/formula-1-car.jpg',
        text:"Formula-1",
    ...
    ,
    {
        image:'./Pictures/history-supreme-yacht-4.5billion.jpg',
    ...
    {
        image:'./Pictures/apache-helicopter.jpg',
        text:"Apache Hhelicopter",
        price:"₹ 1,067,900,000"
        
    },
    {
        image:'./Pictures/boeing-747.jpg',
        text:"Boeing-747"
        ,
        price:"₹ 84,00,00,00,000"
    },
    {
        image:'./Pictures/Rolls-Royce-Boat-Tail-768x411-28milliondolla.jpg',
    ...
    {
        image:'./Pictures/antilia-15000.jpg',
        text:"Antilia",
    ...
    ,
    {
        image:'./Pictures/cruise-ship.jpg',
...
function convertAmountToIndianSystem(amount) {
  ...
  if (remainder > 0) {
    result += remainder.toLocaleString(undefined, { maximumFractionDigits: 2 }) + " rupees";
  }
   ...
   const itemname=itemwrapper.getElementsByClassName('item-name')[0];
    ...
    if (quantityInput.value === '0') {
      ...
      sellButton.addEventListener('click', function () {
        ...
        if (inputValue > 0) {
         ...
         totalCostElement.innerHTML = `<hr><h3> Total Cost : ${totalCost}  ( ${convertAmountToIndianSystem(1820400000000-finalvalue)} )</h3>`;
      ...
      if(Math.floor(finalvalue/extractNumericValue(itemprice.innerText))>=1){
      ...
      if (quantityInput.value === '0') {
        ...
        function decreaseItem() {
          ...
          if ( quantityValue === 1&&existingItems.length === 1) {
              ...
              if (existingItems.length === 1 && totalCostElement&&quantityValue === 1) {
    ...
    quantityInput.addEventListener('input', function () {
      ...
      if (isNaN(inputValue)) {
        ...
        previous=finalvalue;
        finalvalue=finalvalue-diffValue*extractNumericValue(itemprice.innerText);

    if(finalvalue<0){

    quantityInput.value= previousvalue3+Math.floor(previous/extractNumericValue(itemprice.innerText));
...
function animateValue(obj, start, end, duration) {
  ...
  function updateValue(timestamp) {
    ...
    if ((currentValue < end && increment > 0) || (currentValue > end && increment < 0)) {
