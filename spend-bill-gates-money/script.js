...
let finalvalue = 135000000000;
let previous = 135000000000;
var totalCost = 0;
...
function animateValue(obj, start, end, duration) {
  ...
  function updateValue() {
    ...
    if (finalvalue === 0 && window.innerWidth > 420) {
      ...
      obj.textContent =
        "Congratulations! You've successfully spent Bill Gates $135 billion! You're now officially the world's most extravagant spender. Keep on dreaming big!";
      ...
      obj.style.textAlign = "center";
      obj.textContent =
        "Congratulations! You've successfully Bill Gates $135 billion! You're now officially the world's most extravagant spender. Keep on dreaming big!";
...
///INITIAL ANIMATION
animateValue(obj, 0, 135000000000, 1000);
